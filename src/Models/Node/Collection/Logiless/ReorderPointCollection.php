...
use HaruyaNishikubo\Transporter\Models\Node\Entity\Logiless\ReorderPointEntity;

class ReorderPointCollection extends Collection
{
    public function newEntity(array $attributes): Entity
    {
        return new ReorderPointEntity($attributes);
    }
}
