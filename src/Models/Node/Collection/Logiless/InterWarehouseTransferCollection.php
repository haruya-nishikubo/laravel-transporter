...
use HaruyaNishikubo\Transporter\Models\Node\Entity\Logiless\InterWarehouseTransferEntity;

class InterWarehouseTransferCollection extends Collection
{
    public function newEntity(array $attributes): Entity
    {
        return new InterWarehouseTransferEntity($attributes);
    }
}
