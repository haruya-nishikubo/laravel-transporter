...
use HaruyaNishikubo\Transporter\Models\Node\Entity\Logiless\DailyInventorySummaryEntity;

class DailyInventorySummaryCollection extends Collection
{
    public function newEntity(array $attributes): Entity
    {
        return new DailyInventorySummaryEntity($attributes);
    }
}
