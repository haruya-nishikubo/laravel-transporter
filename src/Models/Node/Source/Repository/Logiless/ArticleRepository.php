...
use Carbon\Carbon;
use HaruyaNishikubo\Transporter\Models\Node\Collection\Logiless\ArticleCollection;

class ArticleRepository extends Repository
{
    public function listUrl(): string
    {
        return sprintf(config('transporter.logiless.uri.article.list'), $this->client->merchantId());
    }
